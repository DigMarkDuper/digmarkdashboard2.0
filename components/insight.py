...
def show_insight_page(BRAND_BLUE, BRAND_YELLOW):
    ...
    # =========================================================
    # SMART IMPORTER (LOGIKA INTEGRASI)
    # =========================================================
    ...
    with st.expander("🚀 Upload Data Insight Baru", expanded=True):
        files = st.file_uploader(
            ...
            key=f"ins_v21_{st.session_state.uploader_key}"
        )
        ...
        if files:
            ...
            for f in files:
                try:
                    ...
                    # --- 1. AUTO DETECT ENCODING (DARI SNIPPET ANDA) ---
                    ...
                    # --- 2. LOGIKA TIKTOK (DARI SNIPPET ANDA) ---
